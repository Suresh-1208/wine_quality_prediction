...
# model_path = "decision_tree_model.pkl"  # Update the path as needed
# with open(model_path, "rb") as f:
#     model = pickle.load(f)

# @app.route('/')
# def home():
#     return "Welcome to the Decision Tree Prediction API!"
...
#         # Determine if it's "good" or "not good"
#         quality_label = "good" if prediction >= 7 else "not good"
        
#         # Generate explanations for the prediction
#         explanations = []
#         if quality_label == "good":
#             explanations.append("The wine is classified as good due to its high quality score.")
#             explanations.append("High scores for acidity and aroma may contribute to its classification.")
#         else:
#             explanations.append("The wine is classified as not good due to its lower quality score.")
#             explanations.append("Consider improving factors like flavor balance or tannin levels.")
